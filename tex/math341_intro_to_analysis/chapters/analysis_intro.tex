...
A recurring topic in real analysis will be \dfntxt{convergence}. Many computational techniques and algorithms rely on iteration---successive approximations getting closer to an actual solution. In order for those algorithms to work, they need to converge towards an actual solution.
...
Does this method work for all $c > 0$ and $x_1 > 0$? Assuming this sequence $(x_n)$ converges, then:
\begin{alignat*}{2}
