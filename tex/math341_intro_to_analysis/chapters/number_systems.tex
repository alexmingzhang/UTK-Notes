...
\begin{thmbox}{$\sqrt{2}$ is not a Rational Number}{}
    $\sqrt{2} \notin \Q$
    \tcblower
    \begin{proof}
...
We can think of $\abs{a-b}$ as the distance between $a$ and $b$. More egnerally, $\abs{a-b} = d(a,b)$ is the metric we are using.
...
\begin{dfnbox}{Supremum, Infimum}{}
    ...
    \end{enumerate}
    then $s$ is the \dfntxt{supremum} of $A$, denoted $s = \sup A$.
\end{dfnbox}
