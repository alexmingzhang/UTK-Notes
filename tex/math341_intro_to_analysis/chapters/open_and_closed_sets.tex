...
\begin{dfnbox}{Interior of a Set}{}
    Intuitively, the \dfntxt{interior} of a set is the set containing its elements but not its boundary points.
    \tcblower
    Formally, for $A \subseteq \R$, the \dfntxt{interior} of $A$ is the set $A^{\circ}$ defined as:
...
\begin{dfnbox}{Closure of a Set}{}
    ...
    \tcblower
    Formally, for $A \subseteq \R$, the \dfntxt{closure} of $A$ is the set $\overline{A}$ defined as:
