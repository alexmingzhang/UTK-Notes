\chapter{Sequences and Convergence} \label{chapter-sequences}

\begin{dfnbox}{Sequence}{}
    A \dfntxt{sequence} is an infinite ordered list of real numbers.
...
\begin{dfnbox}{Sequence Boundedness}{}
    ...
    \begin{itemize}[noitemsep]
        \item \dfntxt{bounded above} if there exists $M \in \R$ such that $s_n \leq M$ for all $n \in \N$. We say $M$ is an \dfntxt{upper bound} for the sequence $(s_n)$.
        \item \dfntxt{bounded below} if there exists $m \in \R$ such that $m \leq s_n$ for all $n \in \N$. We say $m$ is a \dfntxt{lower bound} for the sequence $(s_n)$.
        \item \dfntxt{bounded} if it is both bounded above and below.
    \end{itemize}
\end{dfnbox}

\begin{thmbox}{Sequence Convergence Implies Boundedness}{}
...
\begin{dfnbox}{Subsequence}{}
    ...
    Given a sequence $(s_n)$, a \dfntxt{subsequence} is any sequence of the form $(s_{n_k})$ where $(n_k)$ is a strictly increasing sequence of natural numbers.
\end{dfnbox}
