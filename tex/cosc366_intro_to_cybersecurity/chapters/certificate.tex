...
\begin{itemize}
    ...
    \item \dfntxt{Authentication:} provided using signed certificates; authentication of the server is provided, but rarely is authentication of the client provided
\end{itemize}
